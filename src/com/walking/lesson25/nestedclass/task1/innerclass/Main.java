package com.walking.lesson16.abstractclasses.interfaces.task1.abstracts;

// Реализуйте задачу с помощью абстрактного класса.
...
import com.walking.lesson16.abstractclasses.interfaces.task1.abstracts.model.EquilateralFigure;
import com.walking.lesson16.abstractclasses.interfaces.task1.abstracts.model.EquilateralTriangle;
import com.walking.lesson16.abstractclasses.interfaces.task1.abstracts.model.Square;
...
public class Main {
    public static void main(String[] args) {
        ...
        if (!validation(sideLength, selectedShape)) {
            ...
            EquilateralFigure shape = selectedShape == 1 ? new Square(sideLength) : new EquilateralTriangle(sideLength);
