package com.walking.lesson16.abstract_classes_and_interfaces.task1.interfaces;
...
import com.walking.lesson16.abstract_classes_and_interfaces.task1.interfaces.model.Figure;
import com.walking.lesson16.abstract_classes_and_interfaces.task1.interfaces.model.EquilateralRectangle;
import com.walking.lesson16.abstract_classes_and_interfaces.task1.interfaces.model.Square;
...
public class Main {
    public static void main(String[] args) {
        ...
        if (!validation(sideLength, selectedShape)) {
            ...
            Figure shape = selectedShape == 1 ? new Square(sideLength) : new EquilateralRectangle(sideLength);
